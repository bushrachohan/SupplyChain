...
<div className="bg-surface-container px-space-md py-space-sm rounded-lg flex items-center gap-space-sm shadow-sm">
...
<button className="bg-primary hover:bg-primary-container text-on-primary px-space-lg py-space-sm rounded-lg font-label-md text-label-md flex items-center gap-space-xs transition-all shadow-sm">
...
<span className="font-tabular-metric-lg text-tabular-metric-lg text-on-surface font-bold">8</span>
...
<div className="flex items-baseline gap-space-xs mb-space-xs">
<span className="font-tabular-metric-lg text-tabular-metric-lg text-on-surface font-bold">4</span>
...
<stop offset="0%" stop-color="#316bf3" stop-opacity="0.14"></stop>
<stop offset="100%" stop-color="#316bf3" stop-opacity="0.01"></stop>
</lineargradient>
</defs>
{/*  Horizontal Grid Lines  */}
<line opacity="0.6" stroke="#c5c5d3" stroke-dasharray="3,3" stroke-width="1" x1="40" x2="940" y1="20" y2="20"></line>
<text fill="#757682" text-anchor="end" x="32" y="24">500</text>
<line opacity="0.6" stroke="#c5c5d3" stroke-dasharray="3,3" stroke-width="1" x1="40" x2="940" y1="80" y2="80"></line>
<text fill="#757682" text-anchor="end" x="32" y="84">450</text>
<line opacity="0.6" stroke="#c5c5d3" stroke-dasharray="3,3" stroke-width="1" x1="40" x2="940" y1="140" y2="140"></line>
<text fill="#757682" text-anchor="end" x="32" y="144">400</text>
<line opacity="0.8" stroke="#c5c5d3" stroke-width="1" x1="40" x2="940" y1="200" y2="200"></line>
...
<polyline fill="none" points="
            ...
            " stroke="#1e3a8a" stroke-dasharray="5,4" stroke-width="2.5"></polyline>
...
<polyline fill="none" points="
            ...
            " stroke="#0051d5" stroke-width="3"></polyline>
...
<a className="font-label-md text-label-md text-primary font-bold hover:underline flex items-center gap-0.5" href="#">
        Audit Log
...
<script>
  // Simple interactive feedback on evaluate buttons
  document.querySelectorAll('button').forEach(btn => {
    btn.addEventListener('click', (e) => {
      const text = btn.innerText;
      if (text.includes('Evaluate Decision')) {
        const originalHtml = btn.innerHTML;
        btn.innerHTML = '<span className="material-symbols-outlined text-[16px] animate-spin">progress_activity</span><span>Loading Context...</span>';
