...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col justify-between selection:bg-teal-100 selection:text-teal-900 font-sans">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 h-14 sm:h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-1 sm:gap-6">
            <nav className="hidden md:flex items-center gap-5 text-xs sm:text-sm font-medium text-slate-600">
              <a href="#intelligence" className="hover:text-slate-900 transition-colors py-1">Intelligence</a>
              <a href="#capabilities" className="hover:text-slate-900 transition-colors py-1">Capabilities</a>
              <a href="#architecture" className="hover:text-slate-900 transition-colors py-1">Architecture</a>
            </nav>

            <button onClick={() => navigate('/app')} className="inline-flex items-center gap-1.5 px-3.5 py-1.5 sm:px-4 sm:py-2 text-xs sm:text-sm font-medium text-white bg-slate-900 hover:bg-teal-900 rounded-md transition-all shadow-xs active:scale-[0.98] border border-slate-800">
      ...
      <main id="top" className="flex-grow">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-center">
              ...
              <div className="lg:col-span-7 flex flex-col items-start">
                ...
                <div className="flex flex-wrap items-center gap-3 mb-6">
                  <button onClick={() => navigate('/app')} className="inline-flex items-center gap-2 px-5 py-2.5 text-sm font-semibold text-white bg-teal-800 hover:bg-teal-900 rounded-md shadow-xs transition-colors border border-teal-700">
                    <span>Launch Sentinel</span>
                    <span className="text-teal-200 font-bold">→</span>
                  </button>
                  <a href="#intelligence" className="inline-flex items-center gap-2 px-4 py-2.5 text-sm font-medium text-slate-700 hover:text-slate-950 bg-white hover:bg-slate-50 rounded-md border border-slate-300 transition-colors">
              ...
              {/* Hero Abstract Intelligence Flow Visual */}
              <div className="lg:col-span-5 w-full">
                <div className="bg-white rounded-lg border border-slate-200 p-5 shadow-sm">
                  ...
                  <div className="mt-3 pt-2.5 border-t border-slate-100 flex items-center justify-between text-[11px] text-slate-400 font-mono"><span className="text-slate-600">Policy-Aware</span><span>Human-in-the-Loop</span></div>
                </div>
              </div>
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
              ...
              <div className="p-4 rounded-md border border-slate-200 bg-slate-50/40 hover:bg-slate-50 transition-colors">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">Detect stockout and overstock risk before safety buffers are compromised.</p>
              </div>
        ...
        <section id="intelligence" className="py-12 sm:py-16 bg-[#fcfcfd] border-b border-slate-200/80">
          <div className="max-w-6xl mx-auto px-4 sm:px-6">
            ...
            <div className="bg-white rounded-lg border border-slate-200 p-5 sm:p-7 shadow-xs">
              <div className="text-[11px] font-mono text-slate-400 uppercase tracking-wider mb-4 sm:mb-6 flex items-center justify-between border-b border-slate-100 pb-2">
                <span>Decision Intelligence Pipeline</span><span className="text-teal-700 font-medium">Decision Workflow</span>
              </div>
        ...
        <section className="py-14 sm:py-16 bg-[#f8fafc] border-b border-slate-200/80 text-center">
          <div className="max-w-3xl mx-auto px-4 sm:px-6">
            ...
            <div>
              <button onClick={() => navigate('/app')} className="inline-flex items-center gap-2 px-5 py-2.5 text-sm font-semibold text-white bg-slate-900 hover:bg-teal-900 rounded-md transition-all shadow-xs active:scale-[0.98] border border-slate-800">
                <span>Launch Sentinel</span>
                <span className="text-teal-300">→</span>
              </button>
            </div>
